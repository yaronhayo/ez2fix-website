...
const $$Montclair = createComponent(($$result, $$props, $$slots) => {
  const locationData = {
    city: "Montclair",
    neighborhoods: [
      "Upper Montclair",
  ...
  const localServices = [
    {
      ...
      description: "When your garage door breaks at the worst possible moment, our emergency technicians respond fast. We understand that garage door problems don't wait for convenient times in vibrant communities like Montclair.",
      ...
      popular: true,
      testimonial: "Called at 1 AM with a broken door - they were here quickly and fixed it perfectly!",
      badge: "24/7 AVAILABLE"
    },
    {
      title: "Garage Door Spring Repair",
      description: "Broken springs are dangerous and should only be handled by professionals. We safely replace both torsion and extension springs with high-quality parts designed to withstand Essex County weather conditions.",
    ...
    },
    {
      ...
      description: "Upgrade to smart opener technology with WiFi connectivity and battery backup. Perfect for busy Montclair families who want the convenience of checking and controlling their garage door from anywhere.",
    ...
    },
    {
      ...
      description: "Transform your home's curb appeal with a new garage door that complements Montclair's diverse neighborhood character. From traditional to modern styles, we help you choose the perfect door.",
    ...
    },
    {
      ...
      description: "Keep your business running smoothly with reliable commercial garage door service. We handle heavy-duty doors and high-cycle operations for warehouses, retail, and industrial facilities in Montclair area.",
    ...
    },
    {
      ...
      description: "From cable repairs to track alignment, we fix all types of garage door problems with professional expertise and quality parts that are built to last through Essex County weather.",
  ...
  const localReviews = [
    {
      ...
      location: "Upper Montclair, Montclair NJ",
      rating: 5,
    ...
    {
      name: "Michael Chen",
      location: "South Montclair, Montclair NJ",
      rating: 5,
    ...
    {
      name: "Sarah Johnson",
      location: "Montclair Center, Montclair NJ",
      rating: 5,
    ...
    {
      name: "David Thompson",
      location: "Bay Street Corridor, Montclair NJ",
      rating: 5,
    ...
    },
    {
      ...
      location: "Walnut Street District, Montclair NJ",
      rating: 5,
  ...
  const localFAQs = [
    {
      question: "How quickly can you respond to garage door emergencies in Montclair?",
      answer: "We typically respond to emergencies within 1-2 hours throughout Essex County, including all Montclair neighborhoods from Upper Montclair to the Walnut Street District. Our local technicians know the area well and can navigate efficiently to reach you fast."
    },
    {
      question: "Do you service both residential and commercial properties in Montclair?",
      answer: "Yes, we handle everything from historic homes in diverse neighborhoods to commercial facilities in the arts district. Our experience ranges from delicate residential home repairs to heavy-duty commercial installations."
    },
    {
      question: "What garage door brands work best for Montclair's local climate?",
      answer: "We recommend insulated steel doors from LiftMaster, Clopay, and Wayne Dalton for this area. These brands handle New Jersey's humidity and temperature changes well, plus they offer styles that complement both traditional and modern architectural diversity."
    },
    {
      question: "Do you offer maintenance services to prevent problems?",
      answer: "Absolutely! Our annual maintenance programs help prevent costly emergency repairs. This is especially valuable in diverse communities with varied housing types - regular maintenance keeps your door running smoothly year-round."
    },
    {
      question: "Are you licensed and insured to work in Montclair?",
...
From diverse architectural styles to vibrant arts district activity and mixed housing types throughout the community.
</p> </div> <div class="grid md:grid-cols-2 gap-8"> <div class="space-y-4"> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #D2A63C;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Diverse Housing Styles</h4> <p class="text-sm" style="color: #BB8525;">From historic Victorian homes to modern condos, each property type requires specialized garage door solutions that match architectural character.</p> </div> </div> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #EECD5C;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Cultural District Activity</h4> <p class="text-sm" style="color: #BB8525;">The vibrant arts and cultural scene means varying schedules and security needs for residents and businesses alike.</p> </div> </div> </div> <div class="space-y-4"> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #BB8525;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Transit Village Demands</h4> <p class="text-sm" style="color: #BB8525;">High pedestrian and vehicle traffic requires reliable garage access and enhanced security features for resident peace of mind.</p> </div> </div> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #D2A63C;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Community Character</h4> <p class="text-sm" style="color: #BB8525;">Garage doors must complement the diverse neighborhood character while providing modern convenience and security.</p> </div> </div> </div> </div> <div class="text-center mt-8 p-6 rounded-lg" style="background: rgba(210, 166, 60, 0.1);"> <p class="text-lg italic" style="color: #1D1912;">
"Living in ${locationData.city} means enjoying diverse community life with rich arts culture and historic character, but it also brings garage door challenges like architectural variety and security needs. Imagine never worrying about that again—we make it happen."
...
}, "/Users/yaronhayo/Dev_Projects/Projects_2025/ez2fixV2/ez2fix-production/src/pages/service-areas/montclair.astro", void 0);
const $$file = "/Users/yaronhayo/Dev_Projects/Projects_2025/ez2fixV2/ez2fix-production/src/pages/service-areas/montclair.astro";
const $$url = "/service-areas/montclair";
