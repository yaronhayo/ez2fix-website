...
const $$CedarGrove = createComponent(($$result, $$props, $$slots) => {
  const locationData = {
    city: "Cedar Grove",
    neighborhoods: [
      "Cedar Grove Center",
      ...
      "Montclair Heights vicinity"
    ],
    landmarks: [
      "Cedar Grove Park",
      "Cedar Grove Memorial Pool",
      "Pompton Lakes border",
      "Montclair State University area",
      "Route 23 shopping areas"
    ]
  };
  const localServices = [
    {
      title: "24/7 Emergency Garage Door Repair",
      description: "When your garage door breaks at the worst possible moment, our emergency technicians respond fast. We understand that garage door problems don't wait for convenient times in established neighborhoods like Cedar Grove.",
    ...
    },
    {
      ...
      description: "Upgrade to smart opener technology with WiFi connectivity and battery backup. Perfect for Cedar Grove families who want the convenience of checking and controlling their garage door from anywhere.",
    ...
    },
    {
      ...
      description: "Transform your home's curb appeal with a new garage door that complements Cedar Grove's neighborhood character. From traditional to modern styles, we help you choose the perfect door.",
    ...
    },
    {
      ...
      description: "Keep your business running smoothly with reliable commercial garage door service. We handle heavy-duty doors and high-cycle operations for warehouses, retail, and industrial facilities in Cedar Grove area.",
  ...
  const localReviews = [
    {
      ...
      location: "Cedar Grove Center, Cedar Grove NJ",
      rating: 5,
    ...
    },
    {
      ...
      location: "North End, Cedar Grove NJ",
      rating: 5,
    ...
    {
      name: "Sandra Kim",
      location: "South End, Cedar Grove NJ",
      rating: 5,
    ...
    {
      name: "James Wilson",
      location: "Pompton Plains area, Cedar Grove NJ",
      rating: 5,
    ...
    },
    {
      ...
      location: "Montclair Heights vicinity, Cedar Grove NJ",
      rating: 5,
    ...
    {
      name: "Michael Chen",
      location: "Route 23 area, Cedar Grove NJ",
      rating: 5,
  ...
  const localFAQs = [
    {
      question: "How quickly can you respond to garage door emergencies in Cedar Grove?",
      answer: "We typically respond to emergencies within 1-2 hours throughout Essex County, including all Cedar Grove neighborhoods from the Center to Pompton Plains border. Our local technicians know the area well and can navigate efficiently to reach you fast."
    },
    {
      question: "Do you service both residential and commercial properties in Cedar Grove?",
      answer: "Yes, we handle everything from family homes in established neighborhoods to commercial facilities along Route 23. Our experience ranges from delicate suburban home repairs to heavy-duty commercial installations."
    },
    {
      question: "What garage door brands work best for Cedar Grove's local climate?",
      answer: "We recommend insulated steel doors from LiftMaster, Clopay, and Wayne Dalton for this area. These brands handle New Jersey's humidity and temperature changes well, plus they offer styles that complement both traditional and modern neighborhood architecture."
    },
    {
      question: "Do you offer maintenance services to prevent problems?",
      answer: "Absolutely! Our annual maintenance programs help prevent costly emergency repairs. This is especially valuable in well-established communities with seasonal weather changes - regular maintenance keeps your door running smoothly year-round."
    },
    {
      question: "Are you licensed and insured to work in Cedar Grove?",
...
From seasonal weather causing rust and opener failures to established neighborhoods needing reliable family security solutions.
</p> </div> <div class="grid md:grid-cols-2 gap-8"> <div class="space-y-4"> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #D2A63C;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Seasonal Weather Damage</h4> <p class="text-sm" style="color: #BB8525;">New Jersey's harsh winters and humid summers cause rust, warping, and mechanical failures in garage door systems throughout Essex County.</p> </div> </div> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #EECD5C;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Family Home Security</h4> <p class="text-sm" style="color: #BB8525;">Established families need reliable systems that work daily for multiple cars and provide security for busy households with children.</p> </div> </div> </div> <div class="space-y-4"> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #BB8525;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Neighborhood Standards</h4> <p class="text-sm" style="color: #BB8525;">Well-maintained communities require garage doors that enhance property values and match neighborhood aesthetics.</p> </div> </div> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #D2A63C;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Aging Home Systems</h4> <p class="text-sm" style="color: #BB8525;">Older homes may need system upgrades to handle modern convenience expectations while maintaining structural integrity.</p> </div> </div> </div> </div> <div class="text-center mt-8 p-6 rounded-lg" style="background: rgba(210, 166, 60, 0.1);"> <p class="text-lg italic" style="color: #1D1912;">
"Living in ${locationData.city} means enjoying suburban family life in a well-established community, but it also brings garage door challenges like seasonal wear and family security needs. Imagine never worrying about that again—we make it happen."
...
}, "/Users/yaronhayo/Dev_Projects/Projects_2025/ez2fixV2/ez2fix-production/src/pages/service-areas/cedar-grove.astro", void 0);
const $$file = "/Users/yaronhayo/Dev_Projects/Projects_2025/ez2fixV2/ez2fix-production/src/pages/service-areas/cedar-grove.astro";
const $$url = "/service-areas/cedar-grove";
