...
const $$Clifton = createComponent(($$result, $$props, $$slots) => {
  const locationData = {
    city: "Clifton",
    neighborhoods: [
      "Clifton Center",
    ...
    landmarks: [
      ...
      "Clifton Stadium",
      "Botany Woods Park",
      "Route 3 shopping district"
    ]
  };
  const localServices = [
    {
      title: "24/7 Emergency Garage Door Repair",
      description: "When your garage door breaks at the worst possible moment, our emergency technicians respond fast. We understand that garage door problems don't wait for convenient times in busy Clifton.",
    ...
    },
    {
      ...
      description: "Broken springs are dangerous and should only be handled by professionals. We safely replace both torsion and extension springs with high-quality parts designed to withstand urban area conditions.",
    ...
    },
    {
      ...
      description: "Upgrade to smart opener technology with WiFi connectivity and battery backup. Perfect for busy Clifton families who want the convenience of checking and controlling their garage door from anywhere.",
    ...
    },
    {
      ...
      description: "Transform your home's curb appeal with a new garage door that complements Clifton's diverse neighborhood character. From traditional to modern styles, we help you choose the perfect door.",
    ...
    },
    {
      ...
      description: "Keep your business running smoothly with reliable commercial garage door service. We handle heavy-duty doors and high-cycle operations for warehouses, retail, and industrial facilities in Clifton area.",
    ...
    },
    {
      ...
      description: "From cable repairs to track alignment, we fix all types of garage door problems with professional expertise and quality parts that are built to last through Passaic County conditions.",
  ...
  const localReviews = [
    {
      name: "Maria Santos",
      location: "Clifton Center, Clifton NJ",
      rating: 5,
      text: "Our garage door spring snapped during rush hour last week. Ez2Fix responded quickly and replaced it with a heavy-duty spring that's been perfect ever since. Professional service and fair pricing.",
      service: "Spring Replacement"
    },
    {
      name: "James Rodriguez",
      location: "Athenia, Clifton NJ",
      rating: 5,
    ...
    {
      name: "David Kim",
      location: "Botany Village, Clifton NJ",
      rating: 5,
    ...
    },
    {
      ...
      location: "Route 3 area, Clifton NJ",
      rating: 5,
  ...
  const localFAQs = [
    {
      question: "How quickly can you respond to garage door emergencies in Clifton?",
      answer: "We typically respond to emergencies within 1-2 hours throughout Passaic County, including all Clifton neighborhoods from Clifton Center to Allwood. Our local technicians know the area well and can navigate efficiently to reach you fast."
    },
    {
      question: "Do you service both residential and commercial properties in Clifton?",
      answer: "Yes, we handle everything from family homes in Athenia to commercial facilities along Route 3. Our experience ranges from delicate residential home repairs to heavy-duty commercial installations."
    },
    {
      question: "What garage door brands work best for Clifton's local climate?",
    ...
    },
    {
      ...
      answer: "Absolutely! Our annual maintenance programs help prevent costly emergency repairs. This is especially valuable in busy urban areas - regular maintenance keeps your door running smoothly year-round."
    },
    {
      question: "Are you licensed and insured to work in Clifton?",
...
From frequent traffic affecting response times to high humidity causing rust and opener failures in urban environments.
</p> </div> <div class="grid md:grid-cols-2 gap-8"> <div class="space-y-4"> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #D2A63C;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Urban Environmental Damage</h4> <p class="text-sm" style="color: #BB8525;">City pollution, high humidity, and temperature fluctuations cause rust, warping, and mechanical failures in garage door systems.</p> </div> </div> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #EECD5C;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Diverse Architectural Needs</h4> <p class="text-sm" style="color: #BB8525;">Mixed housing styles need different solutions to ensure new systems work properly with existing structures and aesthetics.</p> </div> </div> </div> <div class="space-y-4"> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #BB8525;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Security Concerns</h4> <p class="text-sm" style="color: #BB8525;">A malfunctioning garage door leaves your home vulnerable to break-ins and exposes your family to safety risks.</p> </div> </div> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #D2A63C;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Commercial Demands</h4> <p class="text-sm" style="color: #BB8525;">Busy commercial areas require heavy-duty systems that handle high-cycle operations and minimize downtime.</p> </div> </div> </div> </div> <div class="text-center mt-8 p-6 rounded-lg" style="background: rgba(210, 166, 60, 0.1);"> <p class="text-lg italic" style="color: #1D1912;">
"Living in ${locationData.city} means enjoying urban convenience and community diversity, but it also brings garage door challenges like environmental wear and mixed housing needs. Imagine never worrying about that again—we make it happen."
...
}, "/Users/yaronhayo/Dev_Projects/Projects_2025/ez2fixV2/ez2fix-production/src/pages/service-areas/clifton.astro", void 0);
const $$file = "/Users/yaronhayo/Dev_Projects/Projects_2025/ez2fixV2/ez2fix-production/src/pages/service-areas/clifton.astro";
const $$url = "/service-areas/clifton";
