...
const $$LittleFalls = createComponent(($$result, $$props, $$slots) => {
  const locationData = {
    city: "Little Falls",
    neighborhoods: [
      "Singac",
    ...
    landmarks: [
      ...
      "Willowbrook Mall vicinity",
      "Peckman River Park",
      "Route 23 commercial district",
      "Singac Brook"
    ]
  };
  const localServices = [
    {
      ...
      description: "When your garage door breaks at the worst possible moment, our emergency technicians respond fast. We understand that garage door problems don't wait for convenient times in Little Falls.",
    ...
    },
    {
      ...
      description: "Broken springs are dangerous and should only be handled by professionals. We safely replace both torsion and extension springs with high-quality parts designed to withstand Passaic County weather.",
    ...
    },
    {
      ...
      description: "Upgrade to smart opener technology with WiFi connectivity and battery backup. Perfect for busy Little Falls families who want the convenience of checking and controlling their garage door from anywhere.",
    ...
    },
    {
      ...
      description: "Transform your home's curb appeal with a new garage door that complements Little Falls' neighborhood character. From traditional to modern styles, we help you choose the perfect door.",
    ...
    },
    {
      ...
      description: "Keep your business running smoothly with reliable commercial garage door service. We handle heavy-duty doors and high-cycle operations for warehouses, retail, and industrial facilities in Little Falls area.",
    ...
    },
    {
      ...
      description: "From cable repairs to track alignment, we fix all types of garage door problems with professional expertise and quality parts that are built to last through Passaic County weather.",
  ...
  const localReviews = [
    {
      name: "Jennifer Walsh",
      location: "Singac, Little Falls NJ",
      rating: 5,
    ...
    {
      name: "Mike Rodriguez",
      location: "Little Falls Center, NJ",
      rating: 5,
    ...
    {
      name: "Sarah Thompson",
      location: "Peckman River area, Little Falls NJ",
      rating: 5,
    ...
    {
      name: "David Chen",
      location: "Route 23 corridor, Little Falls NJ",
      rating: 5,
    ...
    {
      name: "Lisa Martinez",
      location: "Notch Road, Little Falls NJ",
      rating: 5,
  ...
  const localFAQs = [
    {
      question: "How quickly can you respond to garage door emergencies in Little Falls?",
      answer: "We typically respond to emergencies within 1-2 hours throughout Passaic County, including all Little Falls neighborhoods from Singac to the Route 23 corridor. Our local technicians know the area well and can navigate efficiently to reach you fast."
    },
    {
      question: "Do you service both residential and commercial properties in Little Falls?",
      answer: "Yes, we handle everything from family homes in Singac to commercial facilities along Route 23. Our experience ranges from delicate suburban home repairs to heavy-duty commercial installations."
    },
    {
      question: "What garage door brands work best for Little Falls' local climate?",
...
From frequent rain causing rust and opener failures to high-traffic suburban areas leading to quicker spring breaks and alignment problems.
</p> </div> <div class="grid md:grid-cols-2 gap-8"> <div class="space-y-4"> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #D2A63C;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Seasonal Weather Damage</h4> <p class="text-sm" style="color: #BB8525;">New Jersey's harsh winters and humid summers cause rust, warping, and mechanical failures in garage door systems throughout Passaic County.</p> </div> </div> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #EECD5C;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Suburban Home Compatibility</h4> <p class="text-sm" style="color: #BB8525;">Family homes need reliable systems that work daily for multiple cars and provide security for busy households.</p> </div> </div> </div> <div class="space-y-4"> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #BB8525;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Security Concerns</h4> <p class="text-sm" style="color: #BB8525;">A malfunctioning garage door leaves your home vulnerable to break-ins and exposes your family to safety risks.</p> </div> </div> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #D2A63C;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Neighborhood Standards</h4> <p class="text-sm" style="color: #BB8525;">Outdated or damaged doors reduce curb appeal and property values in well-maintained neighborhoods.</p> </div> </div> </div> </div> <div class="text-center mt-8 p-6 rounded-lg" style="background: rgba(210, 166, 60, 0.1);"> <p class="text-lg italic" style="color: #1D1912;">
"Living in ${locationData.city} means enjoying suburban community life, but it also brings garage door challenges like seasonal wear and family security needs. Imagine never worrying about that again—we make it happen."
...
}, "/Users/yaronhayo/Dev_Projects/Projects_2025/ez2fixV2/ez2fix-production/src/pages/service-areas/little-falls.astro", void 0);
const $$file = "/Users/yaronhayo/Dev_Projects/Projects_2025/ez2fixV2/ez2fix-production/src/pages/service-areas/little-falls.astro";
const $$url = "/service-areas/little-falls";
