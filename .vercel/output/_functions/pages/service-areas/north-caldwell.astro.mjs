...
const $$NorthCaldwell = createComponent(($$result, $$props, $$slots) => {
  const locationData = {
    city: "North Caldwell",
    neighborhoods: [
      "Mountain Avenue",
    ...
    landmarks: [
      ...
      "Essex County Country Club area",
      "Caldwell University vicinity"
    ]
  };
  const localServices = [
    {
      title: "24/7 Emergency Garage Door Repair",
      description: "When your garage door breaks at the worst possible moment, our emergency technicians respond fast. We understand that garage door problems don't wait for convenient times in luxury communities like North Caldwell.",
      ...
      popular: true,
      testimonial: "Called at 2 AM with a broken door - they were here in an hour and fixed it perfectly!",
      badge: "24/7 AVAILABLE"
    },
    {
      title: "Garage Door Spring Repair",
      description: "Broken springs are dangerous and should only be handled by professionals. We safely replace both torsion and extension springs with commercial-grade parts designed for luxury home applications.",
    ...
    },
    {
      ...
      description: "Upgrade to smart opener technology with WiFi connectivity and battery backup. Perfect for North Caldwell families who want the convenience of checking and controlling their garage door from anywhere.",
    ...
    },
    {
      ...
      description: "Transform your home's curb appeal with a new garage door that complements North Caldwell's luxury neighborhood character. From traditional to modern styles, we help you choose the perfect door.",
      ...
      warranty: "15-Year Warranty",
      popular: false,
      testimonial: "Our new door looks amazing and matches our home's character perfectly!",
      badge: "CURB APPEAL"
    },
    {
      title: "Commercial Garage Door Service",
      description: "Keep your business running smoothly with reliable commercial garage door service. We handle heavy-duty doors and high-cycle operations for warehouses, retail, and industrial facilities in North Caldwell area.",
    ...
    },
    {
      ...
      description: "From cable repairs to track alignment, we fix all types of garage door problems with professional expertise and quality parts that are built to last through Essex County conditions.",
  ...
  const localReviews = [
    {
      ...
      location: "Mountain Avenue, North Caldwell NJ",
      rating: 5,
    ...
    },
    {
      ...
      location: "Gould Avenue, North Caldwell NJ",
      rating: 5,
      text: "We needed a new garage door that would match our home's character. The team helped us choose the perfect style and the installation was flawless. Couldn't be happier!",
      service: "Door Installation"
    },
    {
      name: "Margaret Davidson",
      location: "Personette Avenue, North Caldwell NJ",
      rating: 5,
    ...
    {
      name: "Charles Wilson",
      location: "Hillside Avenue, North Caldwell NJ",
      rating: 5,
    ...
    },
    {
      ...
      location: "Grandview Avenue, North Caldwell NJ",
      rating: 5,
  ...
  const localFAQs = [
    {
      question: "How quickly can you respond to garage door emergencies in North Caldwell?",
      answer: "We typically respond to emergencies within 1-2 hours throughout Essex County, including all North Caldwell neighborhoods from Mountain Avenue to Grandview Avenue. Our local technicians know the area well and can navigate efficiently to reach you fast."
    },
    {
      question: "Do you service both residential and commercial properties in North Caldwell?",
      answer: "Yes, we handle everything from luxury family homes in exclusive neighborhoods to commercial facilities in nearby areas. Our experience ranges from delicate residential home repairs to heavy-duty commercial installations."
    },
    {
      question: "What garage door brands work best for North Caldwell's luxury homes?",
      answer: "We recommend premium insulated steel and custom wood doors from LiftMaster, Clopay, and Wayne Dalton for this area. These brands handle New Jersey's climate while offering styles that complement luxury and traditional architecture."
    },
    {
      question: "Do you offer maintenance services to prevent problems?",
      answer: "Absolutely! Our annual maintenance programs help prevent costly emergency repairs. This is especially valuable in luxury communities with high expectations - regular maintenance keeps your door running smoothly year-round."
    },
    {
      question: "Are you licensed and insured to work in North Caldwell?",
      answer: "Yes, we're fully licensed (License #13VH13553300) and insured to work throughout Essex County. We comply with all local building codes and municipal regulations."
    },
    {
      question: "What areas do you cover for service calls?",
      answer: "We serve all of North Caldwell including Mountain Avenue, Gould Avenue, Personette Avenue, Hillside Avenue, and Grandview Avenue, plus surrounding Essex County communities within a 3-mile radius."
    }
  ];
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Expert Garage Door Service That North Caldwell Homeowners Trust | Ez2Fix", "description": "Fast, reliable garage door repair & installation in North Caldwell, NJ. Licensed contractor serving all luxury neighborhoods. Call (201) 554-6769!" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", $$Header, {})} ${maybeRenderHead()}<main id="main-content"> <!-- Hero Section: Above the Fold --> <section class="py-12 sm:py-16 lg:py-20" style="background: linear-gradient(135deg, #1D1912 0%, #2A2420 100%);"> <div class="container mx-auto px-4"> <div class="max-w-6xl mx-auto"> <!-- Breadcrumb --> <nav class="flex items-center space-x-2 text-sm mb-8" style="color: #BB8525;"> <a href="/" class="hover:underline">Home</a> <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path> </svg> <a href="/service-areas" class="hover:underline">Service Areas</a> <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path> </svg> <span style="color: #EECD5C;">${locationData.city}</span> </nav> <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center"> <!-- Content --> <div> <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-6" style="color: #F3F3E6;"> <span style="color: #F3F3E6;">Top-Rated Garage Door</span><br> <span style="color: #F3F3E6;">Repair & Installation in</span><br> <span style="color: #D2A63C;">${locationData.city}</span> </h1> <p class="text-lg sm:text-xl leading-relaxed mb-8" style="color: #EECD5C;">
Fast, reliable service for ${locationData.city} homeowners—tackle luxury home requirements and daily wear with our expert team today.
...
Call Now: ${siteConfig.business.phone} </a> </div> <!-- Trust Indicators --> <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center text-sm"> <div> <div class="text-2xl font-bold mb-1" style="color: #D2A63C;">10+</div> <div style="color: #EECD5C;">Years Experience</div> </div> <div> <div class="text-2xl font-bold mb-1" style="color: #D2A63C;">24/7</div> <div style="color: #EECD5C;">Emergency Service</div> </div> <div> <div class="text-2xl font-bold mb-1" style="color: #D2A63C;">5.0★</div> <div style="color: #EECD5C;">Customer Rating</div> </div> <div> <div class="text-2xl font-bold mb-1" style="color: #D2A63C;">Licensed</div> <div style="color: #EECD5C;">& Insured</div> </div> </div> </div> <!-- Free Quote Form --> ${renderComponent($$result2, "Card", $$Card, { "class": "p-6 sm:p-8 shadow-2xl border-2", "style": "background-color: #F3F3E6; border-color: #D2A63C;" }, { "default": ($$result3) => renderTemplate` <h3 class="text-xl sm:text-2xl font-bold mb-6 text-center" style="color: #1D1912;">
Free ${locationData.city} Quote Form
</h3> <form action="/booking" method="GET" class="space-y-4"> <input type="hidden" name="location" value="North Caldwell, NJ"> <div> <label class="block text-sm font-semibold mb-2" style="color: #1D1912;">Name</label> <input type="text" name="name" required class="w-full px-4 py-3 rounded-lg border-2 focus:outline-none focus:border-opacity-100 transition-colors" style="border-color: #BB8525; background-color: white;" placeholder="Your full name"> </div> <div> <label class="block text-sm font-semibold mb-2" style="color: #1D1912;">Phone</label> <input type="tel" name="phone" required class="w-full px-4 py-3 rounded-lg border-2 focus:outline-none focus:border-opacity-100 transition-colors" style="border-color: #BB8525; background-color: white;"${addAttribute(siteConfig.business.phone, "placeholder")}> </div> <div> <label class="block text-sm font-semibold mb-2" style="color: #1D1912;">Service Needed</label> <select name="service" required class="w-full px-4 py-3 rounded-lg border-2 focus:outline-none focus:border-opacity-100 transition-colors" style="border-color: #BB8525; background-color: white;"> <option value="">Select a service</option> <option value="Emergency Repair">Emergency Repair</option> <option value="Spring Repair">Spring Repair</option> <option value="Opener Installation">Opener Installation</option> <option value="New Door Installation">New Door Installation</option> <option value="General Repair">General Repair</option> <option value="Commercial Service">Commercial Service</option> </select> </div> ${renderComponent($$result3, "Button", $$Button, { "type": "submit", "class": "w-full py-4 text-lg font-bold rounded-lg transition-all duration-300 hover:shadow-lg transform hover:scale-105", "style": "background: linear-gradient(135deg, #D2A63C 0%, #EECD5C 100%); color: #1D1912;" }, { "default": ($$result4) => renderTemplate`
Get Free Estimate
` })} </form> ` })} </div> </div> </div> </section> <!-- Local Authority Section --> <section class="py-8" style="background-color: #F3F3E6;"> <div class="container mx-auto px-4"> <div class="max-w-4xl mx-auto"> <div class="bg-white rounded-xl p-6 shadow-lg border border-opacity-20" style="border-color: #D2A63C;"> <h3 class="font-bold mb-4 text-lg text-center" style="color: #1D1912;">Why ${locationData.city} Homeowners Choose Us</h3> <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm"> <div class="flex items-center space-x-2"> <svg class="h-4 w-4 flex-shrink-0" style="color: #D2A63C;" fill="currentColor" viewBox="0 0 24 24"> <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"></path> </svg> <span style="color: #1D1912;">Local expertise since 2014</span> </div> <div class="flex items-center space-x-2"> <svg class="h-4 w-4 flex-shrink-0" style="color: #D2A63C;" fill="currentColor" viewBox="0 0 24 24"> <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"></path> </svg> <span style="color: #1D1912;">Luxury home specialists</span> </div> <div class="flex items-center space-x-2"> <svg class="h-4 w-4 flex-shrink-0" style="color: #D2A63C;" fill="currentColor" viewBox="0 0 24 24"> <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"></path> </svg> <span style="color: #1D1912;">Licensed #13VH13553300</span> </div> <div class="flex items-center space-x-2"> <svg class="h-4 w-4 flex-shrink-0" style="color: #D2A63C;" fill="currentColor" viewBox="0 0 24 24"> <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"></path> </svg> <span style="color: #1D1912;">24/7 emergency service</span> </div> </div> </div> </div> </div> </section> <!-- The Problem Section: We Understand Your Unique Challenges --> <section class="py-12 md:py-16" style="background-color: #F3F3E6;"> <div class="container mx-auto px-4"> <div class="max-w-4xl mx-auto"> <div class="text-center mb-12"> <h2 class="text-3xl md:text-4xl font-bold mb-6" style="color: #1D1912;">
...
From luxury home requirements to high-end architectural compatibility in affluent neighborhoods.
</p> </div> <div class="grid md:grid-cols-2 gap-8"> <div class="space-y-4"> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #D2A63C;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Luxury Home Requirements</h4> <p class="text-sm" style="color: #BB8525;">High-end communities expect premium-grade parts, sophisticated installation, and service that matches their luxury lifestyle and property values.</p> </div> </div> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #EECD5C;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Architectural Sophistication</h4> <p class="text-sm" style="color: #BB8525;">Luxury homes require garage doors that complement sophisticated architecture while providing cutting-edge convenience and security features.</p> </div> </div> </div> <div class="space-y-4"> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #BB8525;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Premium Service Expectations</h4> <p class="text-sm" style="color: #BB8525;">Affluent neighborhoods expect white-glove service with meticulous attention to detail, discretion, and respect for property and privacy.</p> </div> </div> <div class="flex items-start space-x-3"> <div class="w-2 h-2 rounded-full mt-3 flex-shrink-0" style="background-color: #D2A63C;"></div> <div> <h4 class="font-semibold mb-2" style="color: #1D1912;">Investment Protection</h4> <p class="text-sm" style="color: #BB8525;">Garage door problems or substandard repairs can significantly impact property values and aesthetic appeal in luxury neighborhoods.</p> </div> </div> </div> </div> <div class="text-center mt-8 p-6 rounded-lg" style="background: rgba(210, 166, 60, 0.1);"> <p class="text-lg italic" style="color: #1D1912;">
"Living in ${locationData.city} means enjoying luxury suburban life with the highest expectations for quality and service, but it also brings garage door challenges like architectural compatibility and investment protection. Imagine never worrying about that again—we make it happen."
